...
setwd("/public/home/tangkaifu/test_hu/process/5-calculate/")
 ...
 filelist_sampleid = "THP-1"

  data_chrXY <- read.table("THP-1.window.bed.region.cov",sep="\t") 
  ...
  chr <-c("chr1","chr2","chr3","chr4","chr5","chr6","chr7","chr8","chr9","chr10","chr11","chr12","chr13","chr14","chr15","chr16","chr17","chr18","chr19","chr20","chr21","chr22","chrX","chrY","chrz") 
  ...
  png(file=paste0("./",filelist_sampleid,".png"),width=750,height=500)
  ...
  max( data2$V2/1000000)
  max( log_normalized)
  ggplot(data2,aes(x=V2/1000000,y =log_normalized))+facet_grid(V1~.,scales="fixed")+geom_line()+theme_classic()+scale_x_continuous(expand = c(0,3))+
